    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                ...
                <!-- Hidden inputs - FIXED dengan null coalescing -->
                ...
                <div>
                    <button type="submit" 
                            class="w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-200">
                ...
                <div class="text-center pt-4">
                    <a href="{{ route('login') }}" 
                       class="text-sm font-medium text-blue-500 hover:text-blue-600 transition duration-200 inline-flex items-center">
